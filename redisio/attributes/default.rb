...
default['redisio']['default_settings'] = {
  ...
  'dbfilename'                 => 'dump.rdb',
  'slaveof'                    => nil,
  'protected_mode'             => 'no', # unspecified by default but could be set explicitly to 'yes' or 'no'
  'masterauth'                 => nil,
...
#The hostnames of the servers. Update these values with private IPs of YOUR three EC2 servers before uploading the cookbook to Chef serverss.
default['redisio']['node1hostname'] = '172.31.92.190'
default['redisio']['node2hostname'] = '172.31.84.86'
default['redisio']['node3hostname'] = '172.31.92.158'
